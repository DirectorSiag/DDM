...
// NOTA: DerrotasWayPoint y toda la clase PasadaCalculator (buildTrackPoints/
// buildWayPoints) solo se usaban para "cargar/representar" derrotas pasadas.
// Esa funcion queda delegada a un programa externo con cartas nauticas.
